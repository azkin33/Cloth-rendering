...
vector<Face> gIndices;
vector<Texture> gTextures;
vector<Normal> gNormals;

GLfloat* vertexData = new GLfloat[gVertices.size() * 3];
GLfloat* normalData = new GLfloat[gNormals.size() * 3];
GLuint* indexData = new GLuint[gIndices.size() * 3];
...
void init() 
{
    ...
    initShaders();
    initVBO();
    cout << "vertCount: "<<gVertices.size() << endl;
}
...
void display()
{
    ...
    glm::mat4 matT = glm::translate(glm::mat4(1.0), glm::vec3(0, 0, -5.0f));
